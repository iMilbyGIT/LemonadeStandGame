...
{ // SOLID PRINCIPLE EXAMPLE - SINGLE RESPONSIBILITY
    class Customer
    {
        ...
        public string flavPreference;
        List<string> flavPreferences;
        ...
        public Customer()
        {
            ...
            flavPreferences = new List<string> { "Lemon-Head", "Sugar-Head", "Balanced-Head" };
            GenerateCustomerNames();
            GenerateWeatherPreferences();
            GenerateFlavorPreferences();
        }
        ...
        void GenerateFlavorPreferences()
        {
            Random rng = new Random();
            int indexValue = rng.Next(0, flavPreferences.Count);
            flavPreference = flavPreferences[indexValue];
        }
    }
}
